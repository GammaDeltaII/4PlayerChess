...
"}")
        ...
        self.widget = QtWidgets.QWidget(self.moveListTab)
        self.widget.setGeometry(QtCore.QRect(10, 10, 302, 543))
        self.widget.setObjectName("widget")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.moveListWidget = QtWidgets.QListWidget(self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget1 = QtWidgets.QWidget(self.pgnTab)
        self.widget1.setGeometry(QtCore.QRect(10, 10, 302, 542))
        self.widget1.setObjectName("widget1")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.widget1)
        self.verticalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.pgnField = QtWidgets.QPlainTextEdit(self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.loadPgnButton = QtWidgets.QPushButton(self.widget1)
        self.loadPgnButton.setObjectName("loadPgnButton")
        self.horizontalLayout_3.addWidget(self.loadPgnButton)
        self.savePgnButton = QtWidgets.QPushButton(self.widget1)
...
"}")
        ...
        self.widget2 = QtWidgets.QWidget(self.fenGroupBox)
        self.widget2.setGeometry(QtCore.QRect(10, 30, 302, 72))
        self.widget2.setObjectName("widget2")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.widget2)
        self.verticalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.fenField = QtWidgets.QPlainTextEdit(self.widget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
...
"color: rgb(0, 0, 0);")
        ...
        self.setFenButton = QtWidgets.QPushButton(self.widget2)
        ...
        self.boardResetButton = QtWidgets.QPushButton(self.widget2)
