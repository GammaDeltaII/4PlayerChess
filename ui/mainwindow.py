...
"color: rgb(0, 0, 0);")
        ...
        self.moveListWidget.setMinimumSize(QtCore.QSize(300, 0))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_3.addWidget(self.pgnField, 0, 0, 1, 5)
        self.getPgnButton = QtWidgets.QPushButton(self.pgnTab)
        self.getPgnButton.setStyleSheet("background-color: rgb(180, 180, 180);")
        self.getPgnButton.setObjectName("getPgnButton")
        self.gridLayout_3.addWidget(self.getPgnButton, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.savePgnButton, 1, 3, 1, 1)
        self.setPgnButton = QtWidgets.QPushButton(self.pgnTab)
        self.setPgnButton.setEnabled(False)
        self.setPgnButton.setStyleSheet("background-color: rgb(180, 180, 180);")
        self.setPgnButton.setObjectName("setPgnButton")
        self.gridLayout_3.addWidget(self.setPgnButton, 1, 2, 1, 1)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.getPgnButton.setText(_translate("mainWindow", "Get"))
        self.savePgnButton.setText(_translate("mainWindow", "Save"))
        self.setPgnButton.setText(_translate("mainWindow", "Set"))
