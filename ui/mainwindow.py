...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.gridLayout.addItem(spacerItem1, 4, 1, 2, 1)
        ...
        self.moveTreeWidget = QtWidgets.QTreeWidget(self.moveListTab)
        self.moveTreeWidget.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.moveTreeWidget.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.moveTreeWidget.setProperty("showDropIndicator", False)
        self.moveTreeWidget.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectItems)
        self.moveTreeWidget.setIndentation(10)
        self.moveTreeWidget.setRootIsDecorated(True)
        self.moveTreeWidget.setItemsExpandable(True)
        self.moveTreeWidget.setObjectName("moveTreeWidget")
        self.moveTreeWidget.headerItem().setText(0, "1")
        self.moveTreeWidget.header().setVisible(False)
        self.gridLayout_2.addWidget(self.moveTreeWidget, 0, 0, 1, 4)
